    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          <div>
            ...
            <p className="text-white/40 font-body max-w-md">
              Discover today's picks — hand-curated products across electronics, fashion, and
              more.
            </p>
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {categoryCounts.map(([category, count]) => (
            ...
            >
              <div className="text-3xl mb-3">{categoryEmojiMap[category] || "📦"}</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          { icon: Tags, title: "Best Prices", desc: "Price-match guarantee", color: "text-green-400" },
        ].map((item) => (
          <div
            key={item.title}
